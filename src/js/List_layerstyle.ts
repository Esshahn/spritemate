    ...
    const template = `
      <div class="window_menu">
        <div class="icons-zoom-area">
          <img src="src/img/ui/icon-zoom-in.png" id="icon-list-zoom-in" title="zoom in">
          <img src="src/img/ui/icon-zoom-out.png" id="icon-list-zoom-out" title="zoom out">
          <img src="src/img/ui/icon-grid.png" id="icon-editor-grid" title="toggle grid borders">
        </div>
        <img src="src/img/ui/icon-list-new.png" id="icon-list-new" title="new sprite">
        <img src="src/img/ui/icon-list-delete.png" id="icon-list-delete" title="remove sprite">
        <img src="src/img/ui/icon-list-copy.png" id="icon-list-copy" title="copy sprite">
        <img src="src/img/ui/icon-list-paste.png" id="icon-list-paste" title="paste sprite">
      </div>
