    ...
    const template = `
      <div class="window_menu">
        <div class="icons-zoom-area">
          <img src="src/img/ui/icon-zoom-plus.png" class="icon-hover" id="icon-editor-zoom-in" title="zoom in">
          <img src="src/img/ui/icon-zoom-minus.png" class="icon-hover" id="icon-editor-zoom-out" title="zoom out">
          <img src="src/img/ui/icon-grid.png" class="icon-hover" id="icon-editor-grid" title="toggle grid">
        </div>

        <img src="src/img/ui/icon-multicolor.png" title="toggle single- & multicolor (c)" class=" icon-hover" id="icon-multicolor">
        <!--
        <img src="src/img/ui/icon-shift-left.png" title="shift left" class="icon-hover" id="icon-shift-left">
        <img src="src/img/ui/icon-shift-right.png" title="shift right" class="icon-hover" id="icon-shift-right">
        <img src="src/img/ui/icon-shift-up.png" title="shift up" class="icon-hover" id="icon-shift-up">
        <img src="src/img/ui/icon-shift-down.png" title="shift down" class="icon-hover" id="icon-shift-down">
        -->
        <img src="src/img/ui/icon-flip-horizontal.png" title="flip horizontal" class="icon-hover" id="icon-flip-horizontal">
        <img src="src/img/ui/icon-flip-vertical.png" title="flip vertical" class="icon-hover" id="icon-flip-vertical">
