    ...
    const template = `
      <div class="window_menu">
        <div class="icons-zoom-area">
          <img src="src/img/ui/icon-zoom-plus.png" class="icon-hover" id="icon-preview-zoom-in" title="zoom in">
          <img src="src/img/ui/icon-zoom-minus.png" class="icon-hover" id="icon-preview-zoom-out" title="zoom out">
        </div>
        <img src="src/img/ui/icon-preview-x2.png" class="icon-hover" id="icon-preview-x" title="double width">
        <img src="src/img/ui/icon-preview-y2.png" class="icon-hover" id="icon-preview-y" title="double height">
        <img src="src/img/ui/icon-preview-overlay.png" class="icon-hover" id="icon-preview-overlay" title="overlay next sprite">
      </div>
